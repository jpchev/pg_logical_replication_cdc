# see https://www.postgresql.org/docs/12/protocol-logicalrep-message-formats.html
    ...
    def read_tuple_data(self) -> TupleData:
        ...
        for column in range(n_columns):
            ...
            if col_data_category in ("n", "u"):
                ...
                column_data.append(
                    ColumnData(col_data_category=col_data_category, col_data_length=col_data_length, col_data=col_data))
            else:
